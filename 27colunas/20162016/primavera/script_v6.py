...
file1 = 'primavera20112016_90_10.h5'
file2 = 'primavera20112016_90_10.txt'
...
base = pd.read_csv('primavera2016_2016_treinamento.csv')
file_teste = 'primavera2016_2016_teste.csv'
    ...
    for c in range(len(configuracoes)):
        ...
        for epoca in epocas:
            for batch in batchSizes:
                ...
                plt.savefig('v6.primavera.2016-2016.'+str(len(configuracao))+'Cam.'+str(configuracao[0].neuronio)+'Neu.'+nome_tipo+'Tipo.Temp.'+nome+'.Ant.'+str(anterior)+'.png')
                #plt.show()
                plt.close()

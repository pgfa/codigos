...
base = pd.read_csv('inverno2016_2016_treinamento.csv')
file_teste = 'inverno2016_2016_teste.csv'
    ...
    for c in range(len(configuracoes)):
        ...
        for epoca in epocas:
            for batch in batchSizes:
                ...
                plt.savefig('v6.inverno.2016-2016.'+str(len(configuracao))+'Cam.'+str(configuracao[0].neuronio)+'Neu.'+nome_tipo+'Tipo.Temp.'+nome+'.Ant.'+str(anterior)+'.png')
                #plt.show()
                plt.close()

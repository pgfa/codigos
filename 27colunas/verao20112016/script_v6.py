...
file1 = 'verao20112016_90_10.2020.h5'
file2 = 'verao20112016_90_10.2020.txt'
...
base = pd.read_csv('verao20112016-treinamento.csv')
file_teste = 'verao20112016-teste.csv'
    ...
    for c in range(len(configuracoes)):
        ...
        for epoca in epocas:
            for batch in batchSizes:
                ...
                plt.savefig('v6.'+str(len(configuracao))+'Cam.'+str(configuracao[0].neuronio)+'Neu.'+nome_tipo+'Tipo.Temp.'+nome+'.Ant.'+str(anterior)+'.png')
                #plt.show()
                plt.close()

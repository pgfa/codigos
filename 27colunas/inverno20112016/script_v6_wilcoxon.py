...
file1 = 'inverno20112016_90_10.h5'
file2 = 'inverno20112016_90_10.txt'
...
#Bases
base = pd.read_csv('inverno20112016-treinamento.csv')
file_teste = 'inverno20112016-teste.csv'
    ...
    for c in range(len(configuracoes)):
        ...
        for epoca in epocas:
            for batch in batchSizes:
                ...
                #Teste de Wilcoxon
                stat, p = wilcoxon(preco_real_teste, previsoes)
                ...
                plt.savefig('v6.wilcoxon.'+str(len(configuracao))+'Cam.'+str(configuracao[0].neuronio)+'Neu.'+nome_tipo+'Tipo.Temp.'+nome+'.Ant.'+str(anterior)+'.Wilcoxon_p='+str(p)+'.png')
                #plt.show()
                plt.close()
